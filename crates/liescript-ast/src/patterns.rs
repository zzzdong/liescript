use liescript_lexical::{ident::{IdentSpan, Identifier}, literal::{Literal, LiteralSpan}, token::{Brace, Bracket, Paren, Punctuated, TokenSpan}, HasSpan, Span, Spanned};

use crate::{expressions::Expression, names::PathInExpression};
